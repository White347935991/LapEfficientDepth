...
parser.add_argument('--model_dir',type=str, default = 'pretrained/LDRN_ETH3D_Res_Efficient_m_pretrained.pkl')
parser.add_argument('--img_dir', type=str, default = None)
parser.add_argument('--img_folder_dir', type=str, default= 'box_img')
...
for i, img_file in enumerate(img_list):
    ...
    if args.pretrained == 'KITTI':
        ...
        out = out*256.0
    elif args.pretrained == 'NYU' or args.pretrained == 'ETH3D':
        out = out*1000.0
