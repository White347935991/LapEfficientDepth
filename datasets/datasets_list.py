...
class MyDataset(data.Dataset):
    def __init__(self, args, train=True, return_filename = False):
        ...
        if train is True:
            if args.dataset == 'KITTI':
                ...
                self.datafile = args.trainfile_eth3d
                self.angle_range = (-2.5, 2.5)
                self.depth_scale = 1000.0
                args.height = 448
                args.width = 576
            ...
            if args.dataset == 'KITTI':
                ...
                self.datafile = args.testfile_eth3d
                self.depth_scale = 1000.0
                args.height = 448
                args.width = 576
        self.train = train
    ...
    def __getitem__(self, index):
        ...
        if (self.train is False):
            ...
            if self.args.dataset == 'KITTI':
                ...
                if divided_file[1] != 'None':
                    ...
                    pass
            elif self.args.dataset == 'NYU' or self.args.dataset == 'ETH3D':
        ...
        if ((self.args.dataset == 'NYU' or self.args.dataset == 'ETH3D') and (self.train is False) and (self.return_filename is False)):
            # rgb = rgb.crop((40,42,616,474))
            rgb = rgb.crop((40,34,616,482))
        else:
...
class Transformer(object):
    def __init__(self, args):
        ...
        elif args.dataset == 'NYU' or args.dataset == 'ETH3D':
            self.train_transform = EnhancedCompose([
                RandomCropNumpy((args.height,args.width)),
                RandomHorizontalFlip(),
