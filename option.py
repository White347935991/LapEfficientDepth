...
parser.add_argument('--trainfile_eth3d', type=str, default = "./datasets/eth3d_train.txt")
parser.add_argument('--testfile_eth3d', type=str, default = "./datasets/eth3d_test.txt")
