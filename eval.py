...
parser.add_argument('--trainfile_eth3d', type=str, default = "./datasets/ETH3D/eth3d_train.txt")
parser.add_argument('--testfile_eth3d', type=str, default = "./datasets/ETH3D/eth3d_val.txt")
    ...
    if args.evaluate is True:
        ...
        for i in range(test_len):
            ...
            if args.dataset == 'KITTI':
                ...
                errors, error_names = validate(args, val_loader, test_model, logger,'ETH3D')
